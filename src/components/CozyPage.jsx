...
import cozyBackground from "../assets/cozy-background.mp4";
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden bg-black">
                ...
                >
                    <source src={cozyBackground} type="video/mp4" />
                </video>
                    ...
                    <div className="space-y-4 font-Volkhov flex-1 min-h-0 overflow-y-auto pr-2 playlist-scroll">
                        ...
                        {songs.map((song, index) => (
                            <button
                                ...
                                `}
                            >
                                <h3 className="text-white text-lg font-Volkhov">
                                    {song.title}
                                </h3>

                                <p className="text-white/60 text-sm font-Volkhov">
                                    {song.artist}
                                </p>
                            </button>
                        ))}
            ...
            >
                ...
                <div className="flex flex-col items-center p-8">
                    ...
                    <h2 className="text-white text-3xl font-Volkhov mb-8">
                        Now Playing
                    </h2>
                    ...
                    <h3 className="text-white text-2xl mt-8 font-Volkhov">
                        {currentSong.title}
                    </h3>

                    <p className="text-white/60 mt-2 font-Volkhov">
                        {currentSong.artist}
                    </p>
