...
import StarThumb from "../assets/star.png";
        ...
        <div className="relative min-h-screen overflow-hidden">
            ...
            <style>{`
                ...
                .dream-progress::-webkit-slider-thumb {
                    ...
                    height: 40px;
                    margin-top: -21px;
                    background-image: url(${StarThumb});
            ...
            >
                ...
                <div className="p-8 h-full flex flex-col">
                    ...
                    <h2 className="text-white text-3xl mb-8 shrink-0 font-CormorantGaramond">
                        Dream Playlist
                    </h2>

                    <div className="space-y-4 font-CormorantGaramond flex-1 min-h-0 overflow-y-auto pr-2 playlist-scroll">
