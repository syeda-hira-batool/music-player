...
import comfortBackground from "../assets/comfort-background.mp4";
        ...
        <div className="relative min-h-screen overflow-hidden">
            ...
            >
                ...
                <div className="p-8 h-full flex flex-col">
                    ...
                    <h2 className="text-white text-3xl mb-8 shrink-0 font-QuickSand">
                        Comfort Playlist
                    </h2>

                    <div className="space-y-4 font-QuickSand flex-1 min-h-0 overflow-y-auto pr-2 playlist-scroll">
                        ...
                        {songs.map((song, index) => (
                            <button
                                ...
                                `}
                            >
                                <h3 className="text-white text-lg font-QuickSand">
                                    {song.title}
                                </h3>
            ...
            >
                ...
                <div className="flex flex-col items-center p-8">
                    ...
                    <h2 className="text-white text-3xl font-QuickSand mb-8">
                        Now Playing
                    </h2>
                    ...
                    <h3 className="text-white text-2xl mt-8 font-QuickSand">
                        {currentSong.title}
                    </h3>

                    <p className="text-white/60 mt-2 font-QuickSand">
                        {currentSong.artist}
                    </p>
